...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const bEmbed = new EmbedBuilder()
      ...
      .setDescription(
        `${targetMember.user.username} has been temporarily banned for ${banReason}! **(Ban will end: <t:${banEndTime}:R></t:$>)**`
      );
        ...
        try {
          ...
          const lEmbed = new EmbedBuilder()
            ...
            .addFields(
              {
                name: "Tempbanned by",
                value: `<@${interaction.user.id}> for ${banReason}! **(Ban will end on: <t:${banEndTime}:RR></t:$>**`,
                inline: true,
              },
              {
                name: "Reason",
            ...
            .setFooter({
              ...
              text: `${externalMember.user.username} - Logging system`,
            });
    ...
    setTimeout(async () => {
      await interaction.channel.message.delete(followUpMessageId);
    }, 2000);
    setTimeout(async () => {
